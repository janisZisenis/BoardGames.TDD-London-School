...
import Lib.Model.Board.BoardDummy;
...
public class BoardPresenterTest {
    ...
    @Test
    void IfNoWinningLineIsProvided_ViewHasDisplayedBoardOnUpdate() {
    ...
    @Test
    void IfWinningLineIsProvided_ViewHasDisplayedWinningLineOnUpdate() {
